...
def get_token_counts(df, TOKENS_OF_INTERST, tag):
...
token_counts = pd.merge(pre_train_token_counts, train_token_counts, on=["token_type"], how="inner")
token_counts = pd.merge(token_counts, test_token_counts, on=["token_type"], how="inner")
